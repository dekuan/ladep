...
<script src="{{asset('/wap/js/const.js')}}" xsdep="1"></script>
<script src="{{asset('/wap/js/userinfo_nickname.js')}}" xsdep="1"></script>
<script src="{{asset('/wap/js/userinfo_loaddata.js')}}" xsdep="1"></script>
<script src="{{asset('/wap/js/xslib.js')}}" xsdep="1"></script>
<script>
