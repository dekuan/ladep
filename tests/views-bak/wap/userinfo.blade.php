...
<head>
    ...
    <link href="{{asset('/wap/css/common.css')}}" rel="stylesheet" type="text/css" xsdep="1">
    <link href="{{asset('/wap/css/main.css')}}" rel="stylesheet" type="text/css" xsdep="1">
...
<script src="{{asset('/wap/js/jquery.mobile.custom.js')}}" xsdep="1"></script>
<script src="{{asset('/wap/js/jquery.touchSwipe.min.js')}}" xsdep="1"></script>
<script src="{{asset('/wap/js/userinfo.js')}}" xsdep="1"></script>
<script src="{{asset('/wap/js/mavatar.js')}}" xsdep="1"></script>
...
<script src="{{asset('/wap/js/date.js')}}" xsdep="1"></script>
<script src="{{asset('/wap/js/iscroll.js')}}" xsdep="1"></script>
